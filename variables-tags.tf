...
variable "purpose" {
  type        = string
  description = "Detailed description for why these resources are being launched. For any resource with a TTL of -1, this must have justification information for why this is a permanent resource."
}
...
variable "terraform" {
  type        = string
  description = "(true|false) whether the resources were created with Terraform. These should almost always be true."
  default     = "true"
}
